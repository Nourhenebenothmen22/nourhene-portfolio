...
`,J=new Map,Vt=(t,o)=>{nt(()=>{if(!t||typeof document>"u")return;let e=document,s=J.get(e);if(s){o&&s.setAttribute("nonce",o);return}let i=e.createElement("style");i.textContent=t,o&&i.setAttribute("nonce",o),e.head.appendChild(i),J.set(e,i)},[o])};function Yt(t){return Vt(Kt,t.nonce),n.createElement(qt,{...t})}export{g as n,Gt as t};
