...
`,Z=new Map,Yt=(t,o)=>{nt(()=>{if(!t||typeof document>"u")return;let e=document,s=Z.get(e);if(s){o&&s.setAttribute("nonce",o);return}let i=e.createElement("style");i.textContent=t,o&&i.setAttribute("nonce",o),e.head.appendChild(i),Z.set(e,i)},[o])};function Qt(t){return Yt(Kt,t.nonce),n.createElement(qt,{...t})}export{g as n,Gt as t};
